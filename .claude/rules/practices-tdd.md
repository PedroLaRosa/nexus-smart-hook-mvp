...
- I follow the design rules @.claude/rules/design-naming.md, @.claude/rules/design-functions.md, @.claude/rules/design-classes-modules.md
...
- I suggest constant incremental improvements following @.claude/rules/design-naming.md, @.claude/rules/design-functions.md, @.claude/rules/design-classes-modules.md
