...
### 3. Feedback
- I apply TDD strictly to get immediate feedback as defined in @.claude/rules/practices-tdd.md
...
I follow the TDD cycle defined in @.claude/rules/practices-tdd.md. Since I am both roles at the same time, my internal process is:
...
6. Consult @.claude/rules/design-naming.md, @.claude/rules/design-functions.md, and @.claude/rules/design-classes-modules.md during refactoring
